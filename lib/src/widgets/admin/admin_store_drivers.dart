...
class AdminStoreDrivers extends StatefulWidget {
  final String storeId;
  final bool isSelectDriver;
  AdminStoreDrivers({Key key, this.storeId, this.isSelectDriver})
      : super(key: key);

  @override
  _AdminStoreDriversState createState() => _AdminStoreDriversState();
}

class _AdminStoreDriversState extends State<AdminStoreDrivers> {
            ...
            if (picker != null) {
              Firestore.instance
                ...
                Firestore.instance
                    ...
                    .document(widget.storeId)
                    .updateData({
                  'driverIds': FieldValue.arrayUnion([picker.uid])
                });
                Firestore.instance
                    .collection('users')
                    .document(picker.uid)
  ...
  Widget _providerCard(User provider, BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        if (widget.isSelectDriver ?? false) {
