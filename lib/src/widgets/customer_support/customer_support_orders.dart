...
class CustomerSupportOrders extends StatefulWidget {
  final String storeId;
  CustomerSupportOrders({Key key, this.storeId}) : super(key: key);

  @override
  _CustomerSupportOrdersState createState() => _CustomerSupportOrdersState();
}

class _CustomerSupportOrdersState extends State<CustomerSupportOrders>
...
List<Widget> _orderList(AsyncSnapshot snapshot, BuildContext context,
  ...
  return snapshot.data.documents.map<Widget>((document) {
    ...
    var format = DateFormat('yyyy-MM-dd, hh:mm aaa');
