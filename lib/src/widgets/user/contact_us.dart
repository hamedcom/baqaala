...
class UserContactUs extends StatefulWidget {
  UserContactUs({Key key}) : super(key: key);

  @override
  _UserContactUsState createState() => _UserContactUsState();
}
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed:
                        (_itemName != '' && _itemDescription != '' && !_isBusy)
                            ? () async {
                                setState(() {
                                  _isBusy = true;
                                });
                                ...
                                if (res != null) {
                                  ...
                                  Get.snackbar('Thank You',
                                      'Your Message Received, we will contact you shortly',
