...
import 'picker_order_details.dart';
import 'package:responsive_flutter/responsive_flutter.dart';

class PickerOrders extends StatefulWidget {
  PickerOrders({
    Key key,
  }) : super(key: key);

  @override
  _PickerOrdersState createState() => _PickerOrdersState();
}

class _PickerOrdersState extends State<PickerOrders>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
      stream: Firestore.instance
          .collection('orders')
          .where('pickerIds', arrayContains: auth.fUser.uid)
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Time Slot : ${order.slot.title}'),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Text(''),
